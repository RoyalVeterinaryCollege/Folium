...
@Component({
  ...
  templateUrl: "html/placements/edit.component.html"  
})
export class EditPlacementComponent implements OnInit {
  ...
  touchUi = false; // Used for the md-datepicker to load in a mobile friendly format.
  ...
  ngOnInit(){
	...
	openPicker(picker:MdDatepicker<Date>){
